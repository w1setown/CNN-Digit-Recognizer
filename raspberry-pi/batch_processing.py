...
def main():
    ...
    # Find all image files in the digits directory
    image_files = sorted(glob.glob("digits/digit*.png"))

    if not image_files:
        print("No digit images found in the 'digits' directory.")
        return
    ...
    for img_path in image_files:
        try:
            ...
            # Send image to preprocessing service
            ...
            # Make prediction
            predicted_digit, confidence, _ = predict_digit(model, preprocessed_image)
